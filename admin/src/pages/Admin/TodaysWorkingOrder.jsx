...
const handleDownloadExcel = () => {
  ...
  return (
    <div className="w-full m-5">
      <p className="mb-3 text-lg font-medium">Today's({todaydate}) Working Orders</p>
...
>
  Download Excel
        ...
        <table className="min-w-full bg-white border border-gray-200">
          ...
          <tbody>
            {bookings.filter((item) => new Date(item.startDate).toLocaleDateString("en-CA") === today && item.workCompleted !== true) .slice().reverse().map((item, i) => (
...
export default TodaysWorkingOrder;

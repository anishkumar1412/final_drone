...
function Pilot() {
    ...
    return (
        <div className='w-full max-w-6xl m-5'>
            <p className='mb-3 text-lg font-medium'>All Pilots</p>

            <div className='bg-white border rounded text-sm min-h-[60vh] max-h-[80vh] overflow-y-scroll' >
                <div className='hidden sm:grid grid-cols-[0.5fr_2fr_3fr_3fr_2fr_1fr_1fr] grid-flow-col px-3 py-3 border-b' >
                    <p>#</p>
                    <p>Name</p>
                    <p>Email</p>
                    <p>Mobile</p>
                ...
                {
                    allUsers.filter(user => user.role === "Pilot").map((item, i) => (
                        <div className='flex flex-wrap justify-between max-sm:gap-2 sm:grid sm:grid-cols-[0.5fr_2fr_3fr_3fr_2fr_1fr_1fr] items-center text-gray-500  py-3 px-3 border-b hover:bg-gray-50' key={i} >

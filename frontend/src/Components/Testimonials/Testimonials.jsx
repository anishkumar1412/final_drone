...
const Testimonials = () => {
  ...
  return (
   ...
   > 
      ...
      }}><b style={{color:'blue'}}>Darubrahma  Drones</b>  is dedicated to excellence, as proven by our clients' success. Hear from those who've benefited from our precise, efficient, and safe mapping and surveying solutions</p>

    ...
    <div className="relative w-full h-screen overflow-hidden z-100">
      ...
      <div className="absolute top-0 left-0 w-full h-full bg-black bg-opacity-50 flex flex-col justify-center items-center text-white">
        ...
        <div className="text-center">
          <h1 className="text-4xl font-bold mb-4 text-white">Welcome to Darubramha's AgroDrone</h1>
          <p className="text-lg mb-6 text-white">Revolutionizing agriculture with cutting-edge drone technology.</p>
        </div>
        {/* Learn More Link */}
